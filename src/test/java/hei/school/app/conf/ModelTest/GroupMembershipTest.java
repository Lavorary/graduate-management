...
class GroupMembershipTest {
  ...
  private final User user = new User(UUID.randomUUID(), "Jean", "R.", Roles.STUDENT, "j@hei.school", "x");
  ...
  void should_allow_null_end_date_for_active_membership() {
    GroupMembership membership =
        new GroupMembership(UUID.randomUUID(), Timestamp.valueOf("2023-09-01 00:00:00"), null, user, group);
