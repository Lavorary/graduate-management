...
class TranscriptControllerTest extends FacadeIT {
    ...
    JExam exam =
        examRepository.save(
            JExam.builder()
                ...
                .course(course)
                .build());
    gradeRepository.save(JGrade.builder().exam(exam).student(student).gradedBy(admin).build());
  }
  ...
  void should_accept_when_student_requests_own_transcript() {
    ...
    ResponseEntity<Void> response =
        restTemplate.exchange(
            "/transcripts/" + student.getId(), HttpMethod.POST, request, Void.class);
  ...
  void should_forbid_when_student_requests_another_students_transcript() {
    ...
    ResponseEntity<Void> response =
        restTemplate.exchange(
            "/transcripts/" + otherStudent.getId(), HttpMethod.POST, request, Void.class);
  ...
  void should_return_not_found_when_student_does_not_exist() {
    ...
    ResponseEntity<Void> response =
        restTemplate.exchange("/transcripts/" + unknownId, HttpMethod.POST, request, Void.class);
