package hei.school.app.endpoint.event.consumer;

import hei.school.app.PojaGenerated;
import hei.school.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.app.service.event."
